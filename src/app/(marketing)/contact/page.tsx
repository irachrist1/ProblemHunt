    ...
    <main className="min-h-screen bg-bg-primary px-6 py-16 text-text-primary">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <p className="mt-4 text-sm leading-relaxed text-text-secondary">
          ...
          <a className="text-problem-500 transition-colors hover:text-problem-400" href="mailto:hello@problemhunt.dev">
        ...
        <section className="mt-10 space-y-5 rounded-xl border border-border-subtle bg-bg-secondary p-6 text-sm leading-relaxed text-text-secondary">
          <div>
            ...
            <p className="mt-1">Share what feels broken, what feels promising, and what problems you want surfaced next.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-text-primary">Support</h2>
            <p className="mt-1">Include the page you were using and any relevant screenshots so issues can be reproduced quickly.</p>
          </div>
        </section>
